...
- [ahmedeltaher/MVVM-Android-Voice-AI-Agent](https://github.com/ahmedeltaher/MVVM-Android-Voice-AI-Agent) - MVVM + Kotlin + Retrofit2 + Hilt + Coroutines + Kotlin Flow + mockK + Espresso + Junit5
